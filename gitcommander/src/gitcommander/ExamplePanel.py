...
class ExamplePanel(wx.Panel):
    def __init__(self, parent):
        ...
        self.logger = wx.TextCtrl(
            self, pos=(300, 20), size=(200, 300), style=wx.TE_MULTILINE | wx.TE_READONLY
        )
        ...
        self.editname = wx.TextCtrl(
            self, value="Enter here your name", pos=(150, 60), size=(140, -1)
        )
        ...
        self.lblhear = wx.StaticText(
            self, label="How did you hear from us?", pos=(20, 90)
        )
